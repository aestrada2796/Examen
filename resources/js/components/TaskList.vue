        ...
        <div class="row">
            <div class="col-md-8 mx-auto">
                ...
                <div class="card mb-4">
                    ...
                    <div class="card-body">
                        <form
                            @submit.prevent="editingTask ? updateTask() : createTask()">
                            <div class="mb-3">
                                <label class="form-label" for="taskTitle">Task
                                    Title</label>
                                <input
                                    id="taskTitle"
                            ...
                            <div class="mb-3">
                                ...
                                <select
                                    ...
                                    size="3"
                                >
                                    <option v-for="keyword in keywords"
                                            :key="keyword.id"
                                            :value="keyword.id">
                                        {{ keyword.name }}
                                    </option>
                                </select>
                                <div class="form-text">Hold Ctrl to select
                                    multiple keywords
                                </div>
                            </div>
                            <div class="d-flex gap-2">
                                ...
                                <button v-if="editingTask" class="btn btn-secondary"
                                        type="button"
                                        @click="cancelEdit">
                                    Cancel
                                </button>
                ...
                <div class="card">
                    ...
                    <div class="card-body">
                        ...
                        <span
                            :class="{ 'text-decoration-line-through': task.is_done }">
                          {{ task.title }}
                        </span>
                                            </h6>
                                            <div class="mb-2">
                        <span :class="task.is_done ? 'bg-success' : 'bg-warning'"
                              class="badge">
